...
public class Utils {
     ...
     */
    public Dataset<Row> getStringIndexer(Dataset<Row> dataset, String inputColn, String outputColn) {
        StringIndexer labelIndexer = new StringIndexer();
        labelIndexer.setInputCol(inputColn);//"salary");
        labelIndexer.setOutputCol(outputColn);//"salary_index");
     ...
     */
    private List<PipelineStage> buildOneHotPipelineStage(String colName) {
    ...
    public List<PipelineStage> buildPipeLineForFeaturePreparation() {
        List<PipelineStage> pipelineStages = new ArrayList<>();
        List<PipelineStage> workclassStages = this.buildOneHotPipelineStage("workclass");
        List<PipelineStage> educationStages = this.buildOneHotPipelineStage("education");
        List<PipelineStage> occupationStages = this.buildOneHotPipelineStage("occupation");
        List<PipelineStage> marital_statusStages = this.buildOneHotPipelineStage("marital_status");
        List<PipelineStage> relationshipStages = this.buildOneHotPipelineStage("relationship");
        List<PipelineStage> sexStages = this.buildOneHotPipelineStage("sex");
        List<PipelineStage> native_countryStages = this.buildOneHotPipelineStage("native_country");
        List<PipelineStage> raceStages = this.buildOneHotPipelineStage("race");
